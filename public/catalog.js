...
function setDisplayMode(mode){const final=['both','icon','text'].includes(mode)?mode:'text';document.body.dataset.display=final;localStorage.setItem('cccDisplayMode',final);$('#displayMode').value=final;}
