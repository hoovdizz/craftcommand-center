...
function renderConnection(connection) {
  ...
  const container = $('#connectionContainerName') || $('#connectionHost');
  if (mode) mode.value = connection.mode || 'binhex';
  if (container) container.value = connection.containerName || 'binhex-minecraftbedrockserver';
}
